...
plt.plot(100*np.divide(ford['Ford Open']-ford['Ford Open'].shift(1),ford['Ford Open']))


# In[103]:


plt.hist(100*np.divide(ford['Ford Open']-ford['Ford Open'].shift(1),ford['Ford Open']), bins= 10)
...
plt.hist(100*np.divide(ford['Ford Open']-ford['Ford Open'].shift(1),ford['Ford Open']), bins= 100, label = 'Ford')

plt.hist(100*np.divide(tesla['Tesla Open']-tesla['Tesla Open'].shift(1),tesla['Tesla Open']), bins= 100, label = 'Tesla')

plt.hist(100*np.divide(gm['GM Open']-gm['GM Open'].shift(1),gm['GM Open']), bins= 100, label = 'GM')
...
sns.kdeplot(100*np.divide(ford['Ford Open']-ford['Ford Open'].shift(1),ford['Ford Open']), label = 'Ford')

sns.kdeplot(100*np.divide(tesla['Tesla Open']-tesla['Tesla Open'].shift(1),tesla['Tesla Open']), label = 'Tesla')

sns.kdeplot(100*np.divide(gm['GM Open']-gm['GM Open'].shift(1),gm['GM Open']), label = 'GM')
...
sns.boxplot(100*np.divide(ford['Ford Open']-ford['Ford Open'].shift(1),ford['Ford Open']))
plt.show()
sns.boxplot(100*np.divide(tesla['Tesla Open']-tesla['Tesla Open'].shift(1),tesla['Tesla Open']))
plt.show()
sns.boxplot(100*np.divide(gm['GM Open']-gm['GM Open'].shift(1),gm['GM Open']))
